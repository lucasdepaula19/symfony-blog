...
class App_KernelTestDebugContainer extends Container
{
    ...
    protected function getPostControllerService()
    {
        ...
        return $this->services['App\\Controller\\PostController'] = new \App\Controller\PostController(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['serializer'] ?? $this->getSerializerService()), ($this->services['validator'] ?? $this->getValidatorService()));
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['App\\EventListener\\ValidationExceptionSubscriber'] ?? ($this->privates['App\\EventListener\\ValidationExceptionSubscriber'] = new \App\EventListener\ValidationExceptionSubscriber()));
    ...
    protected function getServicesResetterService()
    {
        ...
        }), ['cache.app' => [0 => 'reset'], 'cache.system' => [0 => 'reset'], 'cache.validator' => [0 => 'reset'], 'cache.serializer' => [0 => 'reset'], 'cache.annotations' => [0 => 'reset'], 'cache.property_info' => [0 => 'reset'], 'cache.messenger.restart_workers_signal' => [0 => 'reset'], 'profiler' => [0 => 'reset'], 'debug.validator' => [0 => 'reset'], 'debug.stopwatch' => [0 => 'reset'], 'debug.event_dispatcher' => [0 => 'reset']]);
    }
    ...
    protected function getTest_PrivateServicesLocatorService()
    {
        return $this->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\EventListener\\ValidationExceptionSubscriber' => ['privates', 'App\\EventListener\\ValidationExceptionSubscriber', 'getValidationExceptionSubscriberService', false],
            ...
            'App\\EventListener\\ValidationExceptionSubscriber' => '?',
    ...
    /**
     * Gets the private 'App\EventListener\ValidationExceptionSubscriber' shared autowired service.
     *
     * @return \App\EventListener\ValidationExceptionSubscriber
     */
    protected function getValidationExceptionSubscriberService()
    {
        include_once \dirname(__DIR__, 4).'\\src\\EventListener\\ValidationExceptionSubscriber.php';

        return $this->privates['App\\EventListener\\ValidationExceptionSubscriber'] = new \App\EventListener\ValidationExceptionSubscriber();
    }
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SmS4DieY4Z', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('vJKhpbZsJ7', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1YlW+s4TTO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kr7JuW0gjF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tu4DiX7+nF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6fsacXcNeJ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
